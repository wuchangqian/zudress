 ...
 */
(function(b) {
    b.fn.extend({accordion: function(n, p, q) {
            return this.each(function() {
                function g(c, s, g) {
                    ...
                    e.siblings().removeClass(k).children(d).slideUp(_speed, function() {
                        ...
                        a < c && b("html, body").animate({scrollTop: a}, 400, "easeOutCubic")
                    });
                    if (0 < m.length)
                        m[s || l](_speed, function() {
                            "block" === m.css("display") ? f.parentsUntil(a, h).addClass(k) : e.removeClass(k);
                            f.parentsUntil(a, d).show()
                        });
                    else
                        f.parentsUntil(a, h).addClass(k), 
                        f.parentsUntil(a, d).show()
                }
                var a = b(this), k = "item-active", l = "slideToggle", t = 200, h = "li", d = "ul, div", r = "ul, li>div", e = ".opener";
