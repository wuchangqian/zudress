...
// protected function _prepareLayout()
	...
	if(version_compare(Mage::getVersion(),'1.4.1.0','>=')){
        ...
        $collection->getSelect()->joinleft(array('one_step'=>'mw_onestepcheckout'),'one_step.sales_order_id=main_table.entity_id',array('mw_deliverydate_date','mw_customercomment_info','mw_deliverydate_time'));
